...
export class AdminDashboardPage {
	...
	constructor(private readonly page: Page) {
        ...
        this.adminDetails = this.page.locator("div").filter({ hasText: "Admin: " }).nth(2);
        this.viewAllRolesLink = this.page.locator("div").filter({ hasText: "View All Roles" }).nth(2);
        this.createNewJobRoleLink = this.page.locator("div").filter({ hasText: "Create New Job Role" }).nth(2);
    }
