...
test.use({
	...
	$uri: [
		({}, use) => use("tests/features/jobRoleDetails.feature"),
		{ scope: "test", box: true },
	],
	...
	// bdd-data-start
	{
		...
		steps: [
			...
			},
			{
				...
				gherkinStepLine: 5,
				keywordType: "Action",
				textWithKeyword: "When I open all job roles",
				stepMatchArguments: [],
			},
			{
				pwStepLine: 9,
				gherkinStepLine: 6,
				keywordType: "Action",
				textWithKeyword: "And I open a job role",
				stepMatchArguments: [],
			},
			{
				pwStepLine: 10,
				gherkinStepLine: 7,
				keywordType: "Outcome",
				textWithKeyword: "Then I should see complete job role details",
				stepMatchArguments: [],
			},
			{
				pwStepLine: 11,
				gherkinStepLine: 8,
				keywordType: "Action",
				textWithKeyword: "When I go back to the job roles list",
				stepMatchArguments: [],
			},
			{
				pwStepLine: 12,
				gherkinStepLine: 9,
				keywordType: "Outcome",
				textWithKeyword: "Then I should be on the job roles page",
				stepMatchArguments: [],
			},
		],
	},
